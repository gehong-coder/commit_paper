# Generated by Django 2.0.1 on 2020-08-16 09:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('snumber', models.DecimalField(decimal_places=2, max_digits=5)),
                ('booksale', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app01.Book')),
            ],
        ),
        migrations.AddField(
            model_name='book',
